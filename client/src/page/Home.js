        ...
        <div>
            ...
            <div className='w-screen h-screen '>
                ...
                <div className='absolute top-[85vh] sm:top-[60vh] pb-8 left-10 sm:w-[50%] pr-5 md:pr-0'>
                    ...
                    Welcome to <strong>Bookworms</strong>, the ultimate site for book lovers! You can discover new books, create a personalized reading list, and share your own reviews and recommendations with a community of fellow bookworms. Join us today and start your literary journey!
                    </div>
