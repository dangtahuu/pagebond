...
const AdminForm = ({user, setOpenModal, setAttachment, text}) => {
    ...
    return (
        <div
            ...
            <div className='flex items-center gap-x-2 '>
                ...
                />
                <div
                    className=' dark:bg-[#4E4F50]/70 grow dark:hover:bg-[#4E4F50] rounded-full px-4 py-[9px] w-[90%] flex justify-start dark:text-[#b0b3b8] font-medium transition-20 h-10 cursor-pointer text-[#65676b] bg-[#E4E6E9]/60 hover:bg-[#E4E6E9]  '
                    onClick={() => {
                        setOpenModal(true);
                    }}>
                    <div className='mr-2 overflow-hidden  text-overflow-ellipsis'>
                        {text || `Create new editorial post, ${user.name}`}
                    </div>
                </div>
            </div>
